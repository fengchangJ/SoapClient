 ...
 * 2019-03-15T09:19:18.104+08:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "HelloWorldImplService",
                  wsdlLocation = "http://192.168.43.10:99/HelloWorld?wsdl",
...
public class HelloWorldImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.43.10:99/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.43.10:99/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
